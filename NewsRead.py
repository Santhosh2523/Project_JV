...
def latestnews():
    api_dict = {"business": "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=API_KEY",
                ...
                "information technology": "https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=API_KEY",
                "technology": "https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=API_KEY"
                }
    content = None
    url = None
    speak(
        "which field news do you want ,[business],[entertainment],[health],[science],[sports],[information technology],[technology]")
    field = input("Type news field that you want :")
